...
QString LOS::AppPrefix(){ return "/run/current-system/sw"; } //Prefix for applications
QString LOS::SysPrefix(){ return "/run/current-system/sw"; } //Prefix for system
...
bool LOS::hasMixerUtility(){
  return QFile::exists("@pavucontrol_qt@");
}

//Launch the graphical audio mixer utility
void LOS::startMixerUtility(){
  QProcess::startDetached("@pavucontrol_qt@");
}

//Check for user system permission (shutdown/restart)
bool LOS::userHasShutdownAccess(){
  return QProcess::startDetached("@dbus_send@ --system --print-reply=literal \
...
void LOS::systemShutdown(bool){ //start poweroff sequence
  ...
  QProcess::startDetached("@dbus_send@ --system --print-reply \
