...
void PanelWidget::SaveSettings(QSettings *settings, QString screenID){
...
QString PanelWidget::getColorStyle(QString current, bool allowTransparency){
  ...
  QColor ccol = QColor(col[0].toInt(), col[1].toInt(), col[2].toInt(), col[3].toInt());
  QColor ncol;
