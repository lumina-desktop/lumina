#QMake project file for installing the lumina-icons theme.
...
BASE_DIR = $${L_SHAREDIR}/icons/lumina-icons

#Now setup the base directory/files
base.path = $${BASE_DIR}
base.files = LICENSE index.theme

icons.path = $${BASE_DIR}/actions/symbolic
icons.files = actions/symbolic/*.svg
